...
/* FIP API functions */
void fcoe_ctlr_init2(struct fcoe_ctlr *, enum fip_state);
void fcoe_ctlr_destroy2(struct fcoe_ctlr *);
void fcoe_ctlr_link_up2(struct fcoe_ctlr *);
int fcoe_ctlr_link_down2(struct fcoe_ctlr *);
int fcoe_ctlr_els_send2(struct fcoe_ctlr *, struct fc_lport *, struct sk_buff *);
void fcoe_ctlr_recv2(struct fcoe_ctlr *, struct sk_buff *);
int fcoe_ctlr_recv_flogi2(struct fcoe_ctlr *, struct fc_lport *,
			 struct fc_frame *);

/* libfcoe funcs */
u64 fcoe_wwn_from_mac2(unsigned char mac[], unsigned int, unsigned int);
int fcoe_libfc_config2(struct fc_lport *, struct fcoe_ctlr *,
		      const struct libfc_function_template2 *, int init_fcp);
