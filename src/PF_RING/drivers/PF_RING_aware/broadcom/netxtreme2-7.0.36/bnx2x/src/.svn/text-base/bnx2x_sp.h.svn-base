...
enum {
	...
	BNX2X_NIV_PENDING_VIFSET_MCP_ACK
#endif
};
...
struct bnx2x_params_from_fw {
	union {
		struct bnx2x_viflist_params viflist_params;
	} u;
};
#endif
...
#ifdef BNX2X_NIV /* ! BNX2X_UPSTREAM */
struct bnx2x_func_niv_update_params {
	u16 vif_id;
	u16 niv_default_vlan;
	u8 allowed_priorities;
};

struct bnx2x_func_niv_viflists_params {
	u16 vif_list_index;
	u8 func_bit_map;
...
#ifdef BNX2X_NIV /* ! BNX2X_UPSTREAM */
		struct bnx2x_func_niv_update_params niv_update;
		struct bnx2x_func_niv_viflists_params niv_viflists;
#endif
...
#ifdef BNX2X_NIV /* ! BNX2X_UPSTREAM */
	/* Buffer to use as a niv ramrod data and its mapping.
	 * This can't be same rdata as above because niv ramrod requests
	 * can arrive to the object in parallel to other ramrod requests.
	 */
	void			*niv_rdata;
	dma_addr_t		niv_rdata_mapping;
#endif
