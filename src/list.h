...
/** 
 * NOTE:
 * In kernel source code, these pointers point to a non-NULL 
 * pointer that will result in page faults to avoid useing 
 * non-initialized list entries. Thus, we redefine these pointers
 * in our source code.
 */
