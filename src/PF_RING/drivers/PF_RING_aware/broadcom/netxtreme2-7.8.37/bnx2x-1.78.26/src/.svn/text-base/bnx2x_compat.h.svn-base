...
#if (defined(SLES_DISTRO) && (SLES_DISTRO >= 0x1103))
#define SLES_SP3_ONWARD
#endif
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 24)) && (VMWARE_ESX_DDK_VERSION < 40000) && !defined(NETIF_F_GRO)
#define napi_complete(napi)		netif_rx_complete(dev)
#endif
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 24)) && (VMWARE_ESX_DDK_VERSION < 40000)
...
#if !defined(__VMKLNX__) && (!defined(RHEL_RELEASE_CODE) || RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(5, 0))
...
#if !defined(HAVE_NETDEV_PRIV) && (LINUX_VERSION_CODE < KERNEL_VERSION(3, 0, 0)) && (LINUX_VERSION_CODE != 0x020603) && (LINUX_VERSION_CODE != 0x020604) && (LINUX_VERSION_CODE != KERNEL_VERSION(2, 6, 5))
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 27)) || defined(BNX2X_DRIVER_DISK) || defined(__VMKLNX__)
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 12)) && !defined(RHEL_RELEASE_CODE)
...
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 26)) && (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 36))
#undef netdev_printk
#define netdev_printk(level, netdev, format, args...)		\
	printk("%s"						\
	       "%s %s: %s: " format, level,			\
...
#if ((!defined(RHEL_RELEASE_CODE) && (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 34))) || \
      (defined(RHEL_RELEASE_CODE) && \
		(((RHEL_MAJOR == 6) && (RHEL_MINOR < 1)) || \
		 ((RHEL_MAJOR == 5) && (RHEL_MINOR < 7)) || \
		  (RHEL_MAJOR < 5))))
...
#if (!defined(SLES_DISTRO) || (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 16))) && (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 18))
...
#if !defined(RHEL_RELEASE_CODE) && (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 35)) && defined(BNX2X_MULTI_QUEUE) && (!defined(SLES_DISTRO) || (SLES_DISTRO < 0x1102) && !defined(SLES11_SP1_UP1)) && (XENSERVER_DISTRO < XENSERVER_VERSION(6, 1, 0))
...
#if defined(NETIF_F_TSO6) && ((!defined(RHEL_RELEASE_CODE) && (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 24))) || \
...
#define skb_frag_size(frag) ((frag)->size)
	...
	(!defined(SLES_DISTRO) || (SLES_DISTRO < 0x1103))
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 7, 0) && (!defined(SLES_SP3_ONWARD))
...
#elif defined(__VMKLNX__) && (VMWARE_ESX_DDK_VERSION >= 55000)
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 33)) && !defined(__VMKLNX__)
...
#if ((defined(RHEL_RELEASE_CODE) && (RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(6, 0))) || (defined(SLES_DISTRO) && (SLES_DISTRO > 0x1101)))
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(3, 10, 0))
#if (defined(CONFIG_PCI_IOV) && ((LINUX_VERSION_CODE >= KERNEL_VERSION(3, 2, 0))  || \
				 (defined(RHEL_RELEASE_CODE) && RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(6, 3)) || \
				 (defined(SLES_DISTRO) && (SLES_DISTRO >= 0x1103))))
